...
st.sidebar.markdown(
    "[🔗 GitHub Profile]("https://github.com/Priea05/logistic-regression")
)
...
if st.button("Predict"):
    ...
    st.write(
        f"Probability of Buying Insurance: {probability:.2f}"
    )
...
st.markdown(
    ...
    "[GitHub](https://github.com/Priea05/logistic-regression
)"
)